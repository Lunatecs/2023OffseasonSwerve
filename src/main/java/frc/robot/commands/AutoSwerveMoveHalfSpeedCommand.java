...
public class AutoSwerveMoveHalfSpeedCommand extends CommandBase {
  ...
  public AutoSwerveMoveHalfSpeedCommand(SwerveDrive drive, double distance, double kP) {
    this.drive = drive;
  ...
  public void execute() {
    ...
    drive.drive(
      new Translation2d(drivePID.calculate(error), 0).times(Constants.Swerve.maxSpeed * 0.5),
      0, 
      true, 
      false
    );
  ...
  public boolean isFinished() {
    return (drivePID.getPositionError() < 500);
